...
// }
    ...
    console.log(Data[8].rating)

    console.log(Data[9].id)
    console.log(Data[9].title)
    console.log(Data[9].image)
    console.log(Data[9].price)
    console.log(Data[9].description)
    console.log(Data[9].category)
    console.log(Data[9].rating)
    ...
    console.log(Data[10].category)
    console.log(Data[10].rating)